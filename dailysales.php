...
<head>
	<!-- js -->			
<link href="jscss/facebox.css" media="screen" rel="stylesheet" type="text/css" />
<script src="jscss/jquery.js" type="text/javascript"></script>
<script src="jscss/facebox.js" type="text/javascript"></script>
<script type="text/javascript">
  jQuery(document).ready(function($) {
    $('a[rel*=facebox]').facebox({
      loadingImage : 'jscss/loading.gif',
      closeImage   : 'jscss/closelabel.png'
    })
  })
</script>
<title>
POS
		...
		<link href="jscss/uniform.default.css" rel="stylesheet" media="screen">
  <link href="jscss/bootstrap.css" rel="stylesheet">

    <link rel="stylesheet" type="text/css" href="jscss/DT_bootstrap.css">
  ...
  <link rel="stylesheet" href="jscss/font-awesome.min.css">
	...
	<!-- combosearch box-->	
	  ...
	  <script src="jscss/jquery-1.7.2.min.js"></script>
    <script src="jscss/bootstra.js"></script>

	
	
<link href="jscss/style.css" media="screen" rel="stylesheet" type="text/css" />
<!--sa poip up-->
...
<a href="dailysales.php?id=cash&invoice=<?php echo $finalcode ?>">Cash</a>
...
<option></option>
	...
	?>
		<option value="<?php echo $row['id'];?>"><?php echo $row['product_name']; ?> - <?php echo $row['product_name']; ?> - <?php echo $row['product_name']; ?></option>
	<?php
				}
			?>
</select>
