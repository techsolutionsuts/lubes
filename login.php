...
$get_data = mysql_query("select * from tblogin where username = '$username' and password ='$password' and status = 'Unblocked'");
...
<div id="content">
<div id="header">
<h1><img src="images/slide/slide1.png">Lubricants Inventory System</h1>
</div>
<div id="main">
