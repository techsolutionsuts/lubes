...
mysql_query("insert into subtracted_products (date, sysdate, productname, qtybefore, qtytakenout, qtyleft, reason, user) values('$aridate',now(),'$product_name','$currentqty','$qtyreduce','$qtyleft','$reason','$personel')") or die(mysql_error());
...
<tr><td>
<center style=" color: red;">You are about to reduced the quantity of the of <?=$row->product_name ?> <p></p> either it is leaking or it is been taken to Dormaa or whatever reason</center><br><br>
<center>
<select style="width:340px;">
  <option value="0">Select what to do with the Product</option>
  <option value="Converted">Convert for sales</option>
...
<span style="color: black;">Reason:</span><textarea type="text" hidde  name="reason"  placeholder="Reasons why ? " required style="width:265px; height:90px;"></textarea>
