...
?>
 ...
 <body>
	...
	<div class="container-fluid">
      <div class="row-fluid">	
	<div class="span10">
	<a href="payments.php"><button class="btn btn-default"><i class="icon-arrow-left"></i> Back to Payments</button></a>
...
<br><br><br><br>
	...
	<br><br><br><br>
		<thead><center>
Cheque payment made for lubricants purchased	<br><br>		
                <tr>
				<th>Date:</th>
				<th>Payment ID:</th>				
                <th>Description:</th>
		...
		<tbody>
				...
				<tr>
					<td colspan="7" style=" text-align:right;"><strong style="font-size: 12px;">Amount: &nbsp;</strong></td>
                   ...
                   for($i=0; $row = $result->fetch(); $i++)
					...
					<td colspan="7" style=" text-align:right;"><strong style="font-size: 12px;">Balance: &nbsp;</strong></td>
					<td colspan="2"><strong style="font-size: 12px;">
					<?php
					$pn=$_GET['Pno'];
                   include('db/connect.php');
