...
$dept1 = $liters.' liters was added from '.$qty.' '.$pname;

//update upon which you are taken from
mysql_query("update tbproduct set    quantity = '$by',Qty_Left = '$by' where id = '$custcode'") or die(mysql_error());
//update the product of which you are adding to
mysql_query("update tbproduct set     quantity = '$adto',Qty_Left = '$adto' where id = '$add'") or die(mysql_error());
