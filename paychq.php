...
$Custcode = $_GET['custcode'];
  ...
  $Ptype = "Cheque";
  $despt = 'Cheque payment for Lubricant(s) bought';
...
mysql_query("INSERT INTO tbpayments(Pno,cust_code,Customer,CustomerRep,Description,PaymentMode, AmountC,Balance,ChqNo,DueDate,Bank,Branch,date,SystemDate,User) values('$pn','$Custcode','$customer','$payee','$despt','$Ptype','$amount','$updatbal','$chqno','$bank','$branch','duedate','$date','$Sydate','$user')") or die(mysql_error());
header("location: payreceipt.php?pno=$pn");
exit();
...
<ul class="breadcrumb" style="float: left; width: 845; background:   #7FFFD4 ;">
			...
			<li class="active" style="float: left;">Cheque Payment</li>
			</ul>
      <br>
</form>
...
<input type="text" hidden name="pno" value="<?php echo $payment ?>">
...
<input type="text" hidden name="cbal" id="cbal" oninput="qty();" value="<?php echo $row['Balance'] ?>">
    ...
    <input type="text" style="width: 250px;" name="chqnum" Placeholder=" Amount here"required value="" class="form-control">
    </td>  
    </tr>
    <tr>
    <td>
    <label>Bank</label>
    <input type="text" style="width: 250px;" name="bank" Placeholder=" Amount here"required value="" class="form-control">
    </td>
    <td>
    <label>Branch</label>
    <input type="text" style="width: 250px;" name="branch" Placeholder=" Amount here"required value="" class="form-control">
    </td>  
    </tr>
    <tr>
    <td>
    <label>Due Date</label>
    <input type="date" style="width: 250px;" name="duedate" Placeholder=" Amount here"required value="" class="form-control">
    </td>
    <td>
    <label>Bal:</label>
