...
?>
 ...
 <body>
	...
	<div class="container-fluid">
      <div class="row-fluid">	
	<div class="span10">
	<a href="credit_sales.php?id=credit&invoice=<?php echo $credit ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Back to Sales</button></a>
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	Sunyani Shell, Opp. Jubilee Park	<br>	<br>
	</center>
	<div>
	<?php
	...
	<table cellpadding="3" cellspacing="0" style="margin-top: -30px; font-family: arial; font-size: 12px;text-align:left;width : 100%;">
		...
		<tr>
		<td><?php echo "Customer: ".$cname; ?></td><br>
        <td><?php echo "Customer Rep: ".$custrep; ?></td>
