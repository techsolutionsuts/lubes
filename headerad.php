...
<div class="row" style="background:lightblue; ">
      <div class="container" style="background-color:white; width: 1300px; box-shadow: 2px 2px 1px 1px">
	  <div class="col-md-11" style="background-color: blue; border: 1px solid black; box-shadow: 1px 0px 10px black;margin:auto; margin-top:10px; ">
      ...
      <div class="col-md-1">
      <h4><a href="adminhome.php?user=<?=$_SESSION['username']?>"><?=$_SESSION['username']?></h4> 
	  <a href="logout.php">Logout</a>
	  </div>
      <div class="col-md-2" style="background-color:pink; margin-top:10px; box-shadow:3px 5px 25px black; border:1px solid gray;">
...
<a style="line-height:30px;" href="staffinfo.php">Staff</a><br>
<a style="line-height:30px;" href="restock.php?id=cash&invoice=<?php echo $restock; ?>">Restock</a><br>
