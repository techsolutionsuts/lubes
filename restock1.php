...
<br><br>
      ...
      ?>
                ...
                <td width="90"><a href="deleterec.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['quantity']; ?>&code=<?php echo $row['prod_code'];?>"><button class="btn btn-mini btn-warning"><i class="icon icon-remove"></i> Remove </button></a></td>
                </tr>
                <?php
                  }
        ...
        ?>
          ...
          <a rel="facebox" href="checkoutrec.php?invoice=<?php echo $_GET['invoice']?>&total=<?php echo$am ?>&cashier=<?php echo $_SESSION['username']?>"<Button type="submit" class="btn btn-info" style="width: 400px; height:55px; margin-left:200px;  margin-top:-5px;"/><i class="icon-plus-sign icon-large"></i> SUBMIT</button></a>
           <br><br>
           </div>
     </div>
